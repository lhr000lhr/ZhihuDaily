...
//     if ([_viewsArray[0] hasPrefix:@"http://"]) {
//         
//         if (_currentPage==0)
//         {
//             [firstView setImageWithURL:[_viewsArray lastObject]];
//             [middleView setImageWithURL:[_viewsArray objectAtIndex:_currentPage]];
//             if ([_viewsArray count] >1) {
//                 [lastView setImageWithURL:[_viewsArray objectAtIndex:_currentPage+1]];
//             }
//         }
//         else if (_currentPage==[_viewsArray count]-1)
//         {
//             [firstView setImageWithURL:[_viewsArray objectAtIndex:_currentPage-1]];
//             [middleView setImageWithURL:[_viewsArray objectAtIndex:_currentPage]];
//             [lastView setImageWithURL:[_viewsArray objectAtIndex:0]];
//         }
//         else
//         {
//             [firstView setImageWithURL:[_viewsArray objectAtIndex:_currentPage-1]];

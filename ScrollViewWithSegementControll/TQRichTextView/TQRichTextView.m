...
- (void)createDefault
{
    ...
    self.runTypeList = TQRichTextRunURLType | TQRichTextRunEmojiType | TQRichTextRunAtType;
    self.lineSpace   = 2.0f;
...
{
    [[self class] createTextRunsWithAttString:attString runTypeList:TQRichTextRunURLType | TQRichTextRunEmojiType |TQRichTextRunAtType];
